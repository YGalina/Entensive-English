...
Record completed reviews here after the detailed report has been saved in its appropriate location.

| Date | Scope | Reviewer | Commit | Verdict | Follow-up |
|---|---|---|---|---|---|
...
- Link detailed review rather than pasting full chat transcripts.
- Identify the reviewed commit whenever possible.
- Use one clear verdict and one next action.
