...
- `exports/batch-c-states-correction-v1/` — approved and frozen Batch C interaction, voice, AI-summary, persistence and continuity states.

Only these four export packages may govern implementation today.
