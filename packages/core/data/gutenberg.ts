...
export const GUTENBERG_BOOKS: GutenbergBook[] = [
  ...
  // ——— Большое расширение витрины (фидбэк «мало контента») ———
  { bookId: "dracula", gutenbergId: 345, title: "Dracula", author: "Bram Stoker", level: "c1", genre: "classic", interests: ["stories"] },
  { bookId: "baskervilles", gutenbergId: 2852, title: "The Hound of the Baskervilles", author: "Arthur Conan Doyle", level: "b2", genre: "classic", interests: ["stories", "psychology"] },
  { bookId: "study-scarlet", gutenbergId: 244, title: "A Study in Scarlet", author: "Arthur Conan Doyle", level: "b2", genre: "classic", interests: ["stories"] },
  { bookId: "time-machine", gutenbergId: 35, title: "The Time Machine", author: "H. G. Wells", level: "b2", genre: "classic", interests: ["science", "stories"] },
  { bookId: "war-worlds", gutenbergId: 36, title: "The War of the Worlds", author: "H. G. Wells", level: "b2", genre: "classic", interests: ["science", "stories"] },
  { bookId: "invisible-man", gutenbergId: 5230, title: "The Invisible Man", author: "H. G. Wells", level: "b2", genre: "classic", interests: ["science", "stories"] },
  { bookId: "sense-sensibility", gutenbergId: 161, title: "Sense and Sensibility", author: "Jane Austen", level: "b2", genre: "classic", interests: ["people", "stories"] },
  { bookId: "persuasion", gutenbergId: 105, title: "Persuasion", author: "Jane Austen", level: "b2", genre: "classic", interests: ["people"] },
  { bookId: "jungle-book", gutenbergId: 236, title: "The Jungle Book", author: "Rudyard Kipling", level: "b1", genre: "fantasy", interests: ["stories", "parenting", "nature"] },
  { bookId: "black-beauty", gutenbergId: 271, title: "Black Beauty", author: "Anna Sewell", level: "b1", genre: "classic", interests: ["stories", "nature", "parenting"] },
  { bookId: "sleepy-hollow", gutenbergId: 41, title: "The Legend of Sleepy Hollow", author: "Washington Irving", level: "b1", genre: "classic", interests: ["stories"] },
  { bookId: "christmas-carol", gutenbergId: 46, title: "A Christmas Carol", author: "Charles Dickens", level: "b1", genre: "classic", interests: ["stories", "spirit"] },
  { bookId: "great-expectations", gutenbergId: 1400, title: "Great Expectations", author: "Charles Dickens", level: "c1", genre: "classic", interests: ["people", "stories"] },
  { bookId: "tale-two-cities", gutenbergId: 98, title: "A Tale of Two Cities", author: "Charles Dickens", level: "c1", genre: "classic", interests: ["people", "stories"] },
  { bookId: "oliver-twist", gutenbergId: 730, title: "Oliver Twist", author: "Charles Dickens", level: "b2", genre: "classic", interests: ["stories", "people"] },
  { bookId: "middlemarch", gutenbergId: 145, title: "Middlemarch", author: "George Eliot", level: "c1", genre: "classic", interests: ["people"] },
  { bookId: "dubliners", gutenbergId: 2814, title: "Dubliners", author: "James Joyce", level: "c1", genre: "classic", interests: ["people", "culture"] },
  { bookId: "scarlet-letter", gutenbergId: 25344, title: "The Scarlet Letter", author: "Nathaniel Hawthorne", level: "c1", genre: "classic", interests: ["people", "psychology"] },
  { bookId: "walden", gutenbergId: 205, title: "Walden", author: "Henry David Thoreau", level: "c1", genre: "classic", interests: ["spirit", "nature"] },
  { bookId: "gullivers-travels", gutenbergId: 829, title: "Gulliver's Travels", author: "Jonathan Swift", level: "b2", genre: "humor", interests: ["humor", "travel"] },
  { bookId: "robinson-crusoe", gutenbergId: 521, title: "Robinson Crusoe", author: "Daniel Defoe", level: "b2", genre: "classic", interests: ["travel", "stories"] },
  { bookId: "monte-cristo", gutenbergId: 1184, title: "The Count of Monte Cristo", author: "Alexandre Dumas", level: "c1", genre: "classic", interests: ["stories", "travel"] },
];
